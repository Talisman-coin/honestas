...
Only requiring some minor changes is talisman.cpp.
...
Changes to talisman.cpp
----------------------
talisman.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
