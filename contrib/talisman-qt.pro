...
RESOURCES += src/qt/talisman.qrc src/qt/talisman_locale.qrc
TRANSLATIONS += src/qt/locale/talisman_bg.ts \
                src/qt/locale/talisman_de.ts \
                src/qt/locale/talisman_en.ts \
                src/qt/locale/talisman_es.ts \
                src/qt/locale/talisman_fi.ts \
                src/qt/locale/talisman_fr.ts \
                src/qt/locale/talisman_it.ts \
                src/qt/locale/talisman_ja.ts \
                src/qt/locale/talisman_pl.ts \
                src/qt/locale/talisman_pt.ts \
                src/qt/locale/talisman_ru.ts \
                src/qt/locale/talisman_sk.ts \
                src/qt/locale/talisman_sv.ts \
                src/qt/locale/talisman_vi.ts \
                src/qt/locale/talisman_zh_CN.ts \
                src/qt/locale/talisman_zh_TW.ts
