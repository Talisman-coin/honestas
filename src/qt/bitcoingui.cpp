    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Talisman Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Talisman address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and talisman: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Talisman Core"), this);
    aboutAction->setStatusTip(tr("Show information about Talisman Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Talisman"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Talisman addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Talisman addresses"));
    ...
    openAction->setStatusTip(tr("Open a talisman: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Talisman Core help message to get a list with possible Talisman command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Talisman Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Talisman network", "", count));
}
...
{
    QString strTitle = tr("Talisman Core"); // default title
