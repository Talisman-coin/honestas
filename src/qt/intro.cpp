...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Talisman Core"),
     ...
     * override -datadir in the talisman.conf file in the default data directory
     * (to be consistent with talismand behavior)
     */
    if(dataDir != getDefaultDataDirectory())
