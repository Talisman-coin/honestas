...
/* *** BEGIN DARKSEND MAGIC - TALISMAN **********
    Copyright (c) 2014-2015, Talisman Developers
        eduffield - evan@talisman-coin.io
        udjinm6   - udjinm6@talisman-coin.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Talisman and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("talisman-darksend");
