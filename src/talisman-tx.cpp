...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Talisman Core talisman-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  talisman-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded talisman transaction") + "\n" +
              "  talisman-tx [options] -create [commands]   " + _("Create hex-encoded talisman transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded talisman transaction
